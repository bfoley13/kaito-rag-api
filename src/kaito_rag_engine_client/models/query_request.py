...
class QueryRequest:
    ...
    Attributes:
        ...
        llm_params (None | QueryRequestLlmParamsType0 | Unset): Optional parameters for the language model, e.g.,
            temperature, top_p
        rerank_params (None | QueryRequestRerankParamsType0 | Unset): Experimental: Optional parameters for reranking.
            Only 'top_n' and 'choice_batch_size' are supported.
    """

    index_name: str
    query: str
    top_k: int | Unset = 5
    llm_params: None | QueryRequestLlmParamsType0 | Unset = UNSET
    rerank_params: None | QueryRequestRerankParamsType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        llm_params: dict[str, Any] | None | Unset
        ...
        rerank_params: dict[str, Any] | None | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_llm_params(data: object) -> None | QueryRequestLlmParamsType0 | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(None | QueryRequestLlmParamsType0 | Unset, data)

        llm_params = _parse_llm_params(d.pop("llm_params", UNSET))

        def _parse_rerank_params(data: object) -> None | QueryRequestRerankParamsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(None | QueryRequestRerankParamsType0 | Unset, data)
